...
| Multi-model panels (arena, architect, interrogate) | Default panel is `claude-opus-5` + `claude-fable-5-1` + `claude-sonnet-5` — three distinct models across three tiers (replaces the cross-vendor diversity lost in translation). |
