...
After the explanation is complete, spawn one architectural critic per model in your configured how-critics list (defaults `claude-opus-4-8`, `claude-sonnet-4-6`, `claude-sonnet-4-6`), all in a single message.
