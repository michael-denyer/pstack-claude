...
Launch one reviewer per model in your configured interrogate list (defaults `claude-opus-5`, `claude-opus-4-8`, `claude-opus-4-6`, `claude-sonnet-5`), all in a single message.
